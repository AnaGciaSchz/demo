...
import utils.json.managing.SuggestionJson;
...
public class JsonUtilsImdb implements JsonUtilsInterface {
    ...
    public SearchTitlesJson getOkJson(Map<String, Object> results) throws ParseException {
        ...
        SuggestionJson suggestion = new SuggestionJson((ArrayList<String>) results.get("suggestion"));

        AggregationsJson aggregationsJson = new AggregationsJson(genres, types, dates);
        return new SearchTitlesJson(titles.length, titles, aggregationsJson, suggestion);
    }
}
